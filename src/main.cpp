...
uint256 hashGenesisBlock("0x000000002e8c368c97a9e8aad1364caad5806324763383afd0d26390c01505b5");
...
const string strMessageMagic = "BitPeso Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000002e8c368c97a9e8aad1364caad5806324763383afd0d26390c01505b5");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BitPesoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BitPesoMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running BitPesoMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BitPesoMiner terminated\n");
        throw;
    }
}
